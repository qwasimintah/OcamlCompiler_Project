...
******** main *********
NOTHING	null
ASSIGN	?v2 (backend.variables.Variable@4d7e1886) backend.instructions.InstructionCALL@3cd1a2f1
NOTHING	?v2 (backend.variables.Variable@4d7e1886)
CALL	print_int backend.variables.Variable@4d7e1886 


------ Register Allocation ------
***main : Variables state***
Var/Arg ?v2 (backend.variables.Variable@4d7e1886)  : r4/r2
