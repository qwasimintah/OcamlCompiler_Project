...
******** main *********
NOTHING	tmpVar1 (backend.variables.VInteger@4d7e1886)
ASSIGN	?v22 (backend.variables.VInteger@5cad8086) 123
NOTHING	tmpVar2 (backend.variables.VInteger@3cd1a2f1)
ASSIGN	?v23 (backend.variables.VInteger@6e0be858) 456
NOTHING	tmpVar15 (backend.variables.VInteger@2f0e140b)
ASSIGN	?v49 (backend.variables.VInteger@3764951d) 789
NOTHING	?v49 (backend.variables.VInteger@3764951d)
ASSIGN	?v48 (backend.variables.Variable@4b1210ee) backend.instructions.InstructionCALL@7440e464
NOTHING	?v48 (backend.variables.Variable@4b1210ee)
CALL	print_int backend.variables.Variable@4b1210ee 

******** label2 *********
NOTHING	?v27 (backend.variables.Variable@49476842)
ASSIGN	?v28 (backend.variables.Variable@61bbe9ba) backend.variables.Variable@49476842
NOTHING	tmpVar3 (backend.variables.VInteger@78308db1)
ASSIGN	?v29 (backend.variables.VInteger@610455d6) 0
IF	backend.variables.VBoolean@27c170f0 THEN label3 ELSE label6

******** label3 *********
NOTHING	tmpVar5 (backend.variables.VInteger@5451c3a8)
ASSIGN	?v30 (backend.variables.VInteger@511d50c0) 0
NOTHING	?v27 (backend.variables.Variable@49476842)
ASSIGN	?v31 (backend.variables.Variable@60e53b93) backend.variables.Variable@49476842
IF	backend.variables.VBoolean@2626b418 THEN label4 ELSE label5
...
******** label5 *********
NOTHING	?v27 (backend.variables.Variable@49476842)
ASSIGN	?v33 (backend.variables.Variable@5e2de80c) backend.variables.Variable@49476842
NOTHING	tmpVar7 (backend.variables.VInteger@5a07e868)
...
******** label6 *********
NOTHING	?v27 (backend.variables.Variable@49476842)
ASSIGN	?v36 (backend.variables.Variable@266474c2) backend.variables.Variable@49476842
NOTHING	tmpVar8 (backend.variables.VInteger@76ed5528)
ASSIGN	?v37 (backend.variables.VInteger@6f94fa3e) 1
...
ASSIGN	?v38 (backend.variables.Variable@5e481248) backend.variables.Variable@2c7b84de
NOTHING	tmpVar9 (backend.variables.VInteger@3fee733d)
ASSIGN	?v39 (backend.variables.VInteger@66d3c617) 0
IF	backend.variables.VBoolean@5acf9800 THEN label7 ELSE label10

******** label7 *********
NOTHING	tmpVar11 (backend.variables.VInteger@4617c264)
ASSIGN	?v40 (backend.variables.VInteger@63947c6b) 0
NOTHING	?v25 (backend.variables.Variable@2c7b84de)
ASSIGN	?v41 (backend.variables.Variable@2b193f2d) backend.variables.Variable@2c7b84de
IF	backend.variables.VBoolean@36baf30c THEN label8 ELSE label9
...
******** label9 *********
NOTHING	?v25 (backend.variables.Variable@2c7b84de)
ASSIGN	?v43 (backend.variables.Variable@355da254) backend.variables.Variable@2c7b84de
NOTHING	tmpVar13 (backend.variables.VInteger@7a81197d)
ASSIGN	?v44 (backend.variables.VInteger@4dc63996) 1
...
******** label10 *********
NOTHING	?v25 (backend.variables.Variable@2c7b84de)
ASSIGN	?v46 (backend.variables.Variable@d716361) backend.variables.Variable@2c7b84de
NOTHING	tmpVar14 (backend.variables.VInteger@5ca881b5)
ASSIGN	?v47 (backend.variables.VInteger@6ff3c5b5) 1
...
Var/Arg ?v49 (backend.variables.VInteger@3764951d)  : r6/r2
Var/Arg ?v22 (backend.variables.VInteger@5cad8086)  : r4/-
Var/Arg ?v48 (backend.variables.Variable@4b1210ee)  : r7/r3
...
Var/Arg ?v36 (backend.variables.Variable@266474c2)  : r10/-
Var/Arg ?v37 (backend.variables.VInteger@6f94fa3e)  : r11/-
...
Var/Arg ?v27 (backend.variables.Variable@49476842)  : -/r2

***label1 : Variables state***
Var/Arg ?v38 (backend.variables.Variable@5e481248)  : r4/-
Var/Arg ?v44 (backend.variables.VInteger@4dc63996)  : r9/-
Var/Arg ?v46 (backend.variables.Variable@d716361)  : r10/-
Var/Arg ?v39 (backend.variables.VInteger@66d3c617)  : r5/-
Var/Arg ?v41 (backend.variables.Variable@2b193f2d)  : r7/-
Var/Arg ?v47 (backend.variables.VInteger@6ff3c5b5)  : r11/-
Var/Arg ?v43 (backend.variables.Variable@355da254)  : r8/-
Var/Arg ?v40 (backend.variables.VInteger@63947c6b)  : r6/-
***label1 : Arguments state***
Var/Arg ?v25 (backend.variables.Variable@2c7b84de)  : -/r2
