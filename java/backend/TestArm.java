...
public class TestArm {
   ...
   public static void main(String[] args){
        ...
        Function _f = new Function("_f", null, add_instr);
       ...
       //RegisterUtils.showRegisters(registers);
        ...
        Parameter px = new Parameter(vx.getName(),vx.getValue(), param_registers, _f);
        Parameter py = new Parameter(vy.getName(),vy.getValue(), param_registers, _f);
        Parameter pz = new Parameter(l.getName(),l.getValue(), param_registers, fundef);
